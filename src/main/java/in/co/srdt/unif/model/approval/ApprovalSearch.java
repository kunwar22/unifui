...
public class ApprovalSearch {
	...
	public ApprovalSearch(long approvalId, long approve1, long approve2, long approve3, long approve4, long approve5,
			long approve6, String category, long reimburseType) {
		super();
	...
	public String toString() {
		return "ApprovalSearch [approvalId=" + approvalId + ", approve1=" + approve1 + ", approve2=" + approve2
				+ ", approve3=" + approve3 + ", approve4=" + approve4 + ", approve5=" + approve5 + ", approve6="
				+ approve6 + ", category=" + category + ", reimburseType=" + reimburseType + "]";
	}
