...
public class SearchParentNavbar {
	...
	public SearchParentNavbar(long navbarid, String navname, String navdescr, long parentid, String isparent, String requestaddr, String createdby, String isactive) {
		this.navbarid = navbarid;
		this.navname = navname;
		this.navdescr = navdescr;
		this.parentid = parentid;
